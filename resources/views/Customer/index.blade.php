...
@section('content')
    <div class="container">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" style="min-width: 200px;">
                        ...
                        <li>
                            <div class="d-flex flex-column px-3"> <!-- Add padding on left and right sides -->
                                <a href="{{ route('customers.export', ['search' => $search]) }}"
                                ...
                                <button type="button" class="btn btn-secondary my-1" data-bs-toggle="modal"
                                    data-bs-target="#importCustomerModal">Import</button> <!-- Adjust margin as needed -->
                            </div>
                        </li>
                    </ul>
                </div>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCustomerModal">Add
                    Customer</button>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="importCustomerForm" method="POST" action="{{ route('customers.import') }}"
        ...
        <!-- Confirmation Modal -->
        <div class="modal fade" id="confirmDeleteCustomerModal" tabindex="-1"
            aria-labelledby="confirmDeleteCustomerModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
