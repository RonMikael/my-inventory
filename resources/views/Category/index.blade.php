                ...
                @forelse($categories as $category)
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-info btn-sm btn-view-category" data-category-id="{{ $category->id }}">View</button>
                            <button class="btn btn-primary btn-sm btn-edit-category" data-category-id="{{ $category->id }}">Edit</button>
                            @if (!$category->isUsed())
                                <button type="button" class="btn btn-danger btn-sm btn-delete" data-bs-toggle="modal" data-bs-target="#confirmDeleteCategoryModal" data-category-id="{{ $category->id }}">Delete</button>
                            @endif
                        </td>
                    </tr>
                @empty
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="mb-3 text-center">
                ...
                <form id="importCategoryForm" method="POST" action="{{ route('category.import') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
