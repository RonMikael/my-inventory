    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <p class="text-muted mb-0">Price Range: ${{ $minPrice }} - ${{ $maxPrice }}</p>
                <!-- Displaying min and max price -->
            </div>
            <div class="d-flex">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" style="min-width: 200px;">
                        ...
                        <li>
                            <div class="d-flex flex-column px-3"> <!-- Add padding on left and right sides -->
                                <a href="{{ route('product.export', ['search' => $search]) }}"
                                ...
                                <button type="button" class="btn btn-secondary my-1" data-bs-toggle="modal"
                                    data-bs-target="#importProductModal">Import</button> <!-- Adjust margin as needed -->
                            </div>
                        </li>
                    </ul>
                </div>
                        ...
                        @forelse($products as $product)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form id="deleteProductForm" action="{{ route('products.destroy', $product) }}"
                    ...
                    <div class="col">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>Reference Number:</strong> {{ $product->reference_number }}
                                </p>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    @if ($product->images->count() > 0)
                                        <div id="kanban-carousel-{{ $product->id }}" class="carousel slide"
                                            ...
                                            <button class="carousel-control-prev" type="button"
                                                data-bs-target="#kanban-carousel-{{ $product->id }}"
                                                data-bs-slide="prev">
                                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                <span class="visually-hidden">Previous</span>
                                            </button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addProductForm" method="POST" action="{{ route('products.store') }}"
                            ...
                            <button type="button" class="btn btn-secondary mb-3" id="addStockButton">Add Another
                                Stock</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editProductForm" method="POST" action="" enctype="multipart/form-data">
                            ...
                            <button type="button" class="btn btn-secondary mb-3" id="addEditStockButton">Add Another
                                Stock</button>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control mt-2" id="editImages" name="images[]"
                                    multiple>
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="importProductForm" method="POST" action="{{ route('products.import') }}"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
        ...
        <div class="modal fade" id="confirmDeleteProductModal" tabindex="-1"
        ...
        <div class="modal fade" id="confirmDeleteStockModal" tabindex="-1"
            aria-labelledby="confirmDeleteStockModalLabel" aria-hidden="true">
